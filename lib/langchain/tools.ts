...
export const getAuctionResultsTool = () => {
  return new DynamicStructuredTool({
    ...
    schema: z.object({
      ...
      sold_price_min: z.number().optional().describe("The minimum sold price of the vehicle"),
      sold_price_max: z.number().optional().describe("The maximum sold price of the vehicle"),
      ...
      end_date_min: z.string().optional().describe("The minimum end date to filter results"),
      end_date_max: z.string().optional().describe("The maximum end date to filter results"),
      ...
      sortField: z.string().optional().describe("Field to sort by (e.g., 'sold_price', 'end_date', 'mileage', 'bidders'). Default is 'end_date'"),
        ...
        if (groupBy && aggregation) {
          return JSON.stringify({
            query: {
              ...
              endDateRange: `${end_date_min || 'Any'}-${end_date_max || 'Any'}`,
              groupBy,
              aggregation
            },
...
function analyzeAuctionBestDeal(results: any[]) {
  ...
  return {
    bestDeals: topDeals.map(deal => ({
      ...
      date: deal.bestDeal.end_date || 'Unknown',
